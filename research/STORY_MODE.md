...
La campaña contiene 50 niveles numerados en cinco capítulos. Usa las ocho familias de salas existentes con variantes de plataformas y defensas, además de tres salas iniciales con Carrot. La progresión es de una trampa en los niveles 1–3, dos en el 4–10, tres en el 11–25, cuatro en el 26–40 y cinco en el 41–50. Su geometría, sus poderes y sus ciclos permanecen fijos durante la partida; el Axie visual es aleatorio por entrada. No requiere billetera.
...
Puntuación inicial: `50 × (1 − proporción de ensayos superados) + 0,65 × saltos + 0,28 × segundos + 5 × trampas + 2 × plataformas de menos de 3 unidades de ancho`, redondeada. El orden inicial se obtuvo con esa estimación. Los reajustes conservan los números de nivel y priorizan la cantidad creciente de defensas; las métricas se recalculan sin reordenar el progreso publicado. Los ensayos no exploran todas las rutas alternativas ni representan un porcentaje de éxito de jugadores. Tampoco garantizan una dificultad estrictamente creciente para cada persona. La siguiente calibración debe usar pruebas humanas: intentos, tiempo hasta superar, puntos de impacto y abandono.

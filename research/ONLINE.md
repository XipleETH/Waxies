...
La segunda edición de gestos (face2) anima articulaciones de ojos, boca, cabeza y patas, con transiciones a la pose de reposo. Se eliminaron todas las palabras y partículas del dibujo. Algunas piezas oculares de los Axies de gestos se sustituyeron por otras partes oficiales para dejar visible la expresión. Las miniaturas usan el fotograma 10. Los IDs de los gestos se conservan para las grabaciones anteriores; Confeti ahora se representa como Baile. Los personajes controlables y la física no cambian.
